...
class AxiomLogger:
    ...
    def error(
        ...
        try:
            ...
            self.logger.error(str(error), exc_info=True, extra=log_entry)
            return True
    ...
    def info(
        ...
        try:
            ...
            self.logger.info(message, exc_info=True, extra=log_entry)
    ...
    def warning(
        ...
        try:
            ...
            self.logger.warning(message, exc_info=True, extra=log_entry)
